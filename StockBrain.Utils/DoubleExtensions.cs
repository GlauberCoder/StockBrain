...
{
    public static double ToPrecision(this double number, int precision = 2) => (double)Math.Round((decimal)number, precision);
    public static double ToPercentage(this double number, int precision = 0) => (double)Math.Round((decimal)number * 100, precision);
